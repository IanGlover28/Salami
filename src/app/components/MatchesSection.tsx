...
const matchData = {
  lastMatch: {
    ...
    opponentName: "Olympus City",
    opponentLogo: "/olympus.png",
    score: "2 - 1",
    reportTitle: "MATCH REPORT: SALAMI RANGERS FC 2-1 Olympus City",
    reportSummary:
      "SALAMI RANGERS FC won 2-1 against Olympus City this afternoon as the Division 3 resumed following the international break.",
    reportDate: "18 OCT 25",
    possession: "58% - 42%",
    shotsOnTarget: "8 - 5",
    corners: "7 - 3",
  },
  nextMatch: {
    ...
    ourTeamName: "Salami Rangers FC",
    ourTeamLogo: "/salami.png",
    opponentName: "Phoenix United",
    opponentLogo: "/olympics.png",
    reportTitle: "UPCOMING: SALAMI RANGERS FC vs Phoenix United",
    reportSummary:
      "A crucial League Cup fixture as we aim to progress to the next round. Phoenix United comes as formidable opponents.",
